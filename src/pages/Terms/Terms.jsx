        ...
        <>
            ...
            <div className='terms_of_use_container'>
                <div className='terms_of_use_subcontainer'>
                    <h2><span className='sub_headers'>TERMS OF USE</span></h2>
                    <p><span className='sub_headers'>Last updated October 04, 2021</span></p>
                    ...
                    <p className='single_gap'></p>
                    <p><span>Supplemental terms and conditions or documents that may be posted on the
                        ...
                        to these Terms of Use from time to time. We will alert you about any changes by
                        ...
                        applicable Terms every time you use our Site so that you understand which Terms apply.
                        ...
                        such revised Terms of Use are posted.</span></p>
                    <p className='single_gap'></p>
                    <p><span>The information provided on the Site is not intended for distribution
                        ...
                        those persons who choose to access the Site from other locations do so on their own
                    ...
                    <p><span>The Site is not tailored to comply with industry-specific regulations
                        ...
                        such laws, you may not use this Site. You may not use the Site in a way that would violate
                        the Gramm-Leach-Bliley Act (GLBA).</span></p>
                    <p className='single_gap'></p>
                    <p><span>The Site is intended for users who are at least 18 years old. Persons
                        under the age of 18 are not permitted to use or register for the Site.</span></p>
                    <p className='single_gap'></p>
                    <p className='single_gap'></p>
                    <h3><span>INTELLECTUAL PROPERTY RIGHTS</span></h3>
                    <p className='single_gap'></p>
                    <p><span>Unless otherwise indicated, the Site is our proprietary property and all source code,
                        ...
                        rights and unfair competition laws of the United States, international copyright laws,
                        and international conventions. The Content and the Marks are provided on the Site “AS IS”
                        ...
                        without our express prior written permission.</span></p>
                    <p className='single_gap'></p>
                    <p><span>Provided that you are eligible to use the Site, you are granted a limited
                        license to access and use the Site and to download or print a copy of any portion
                    ...
                    <p className='single_gap'></p>
                    <p className='single_gap'></p>
                    <h3><span>USER REPRESENTATIONS</span></h3>
                    <p className='single_gap'></p>
                    <p><span>By using the Site, you represent and warrant that: (1) all registration
                        ...
                        with these Terms of Use; (4) you are not a minor in the jurisdiction in which you r
                        eside; (5) you will not access the Site through automated or non-human means, whether
                        through a bot, script, or otherwise; (6) you will not use the Site for any illegal
                        or unauthorized purpose; and (7) your use of the Site will not violate any applicable
                        law or regulation.</span></p>
                    <p><span>If you provide any information that is untrue, inaccurate, not current,
                        or incomplete, we have the right to suspend or terminate your account and
                        refuse any and all current or future use of the Site (or any portion thereof).</span></p>
                    <p className='single_gap'></p>
                    <p className='single_gap'></p>
                    <h3><span>USER REGISTRATION</span></h3>
                    <p className='single_gap'></p>
                    <p><span>You may be required to register with the Site. You agree to keep your
                    ...
                    <p className='single_gap'></p>
                    <p className='single_gap'></p>
                    <h3><span>PROHIBITED ACTIVITIES</span></h3>
                    <p className='single_gap'></p>
                    <p><span>You may not access or use the Site for any purpose other than that
                        for which we make the Site available. The Site may not be used in connection
                        with any commercial endeavours except those that are specifically endorsed or approved by us.
                        As a user of the Site, you agree not to:</span></p>
                    <p className='single_gap'></p>
                    <p><span>1. Systematically retrieve data or other content from the Site to create or compile,
                        directly or indirectly, a collection, compilation, database, or directory without written
                        permission from us.</span></p>
                    <p><span>2. Trick, defraud, or mislead us and other users, especially in any attempt to learn
                        sensitive account information such as user passwords.</span></p>
                    <p><span>3. Circumvent, disable, or otherwise interfere with security-related features of the Site,
                        including features that prevent or restrict the use or copying of any Content or enforce limitations
                        on the use of the Site and/or the Content contained therein.</span></p>
                    <p><span>4. Disparage, tarnish, or otherwise harm, in our opinion, us and/or the Site.</span></p>
                    <p><span>5. Use any information obtained from the Site in order to harass, abuse, or harm another person.</span></p>
                    <p><span>6. Make improper use of our support services or submit false reports of abuse or misconduct.</span></p>
                    <p><span>7. Use the Site in a manner inconsistent with any applicable laws or regulations.</span></p>
                    <p><span>8. Engage in unauthorized framing of or linking to the Site.</span></p>
                    <p><span>9. Upload or transmit (or attempt to upload or to transmit) viruses, Trojan horses,
                        or other material, including excessive use of capital letters and spamming (continuous posting
                        of repetitive text), that interferes with any party’s uninterrupted use and enjoyment of the
                    ...
                    <p><span>10. Engage in any automated use of the system, such as using scripts to send comments or
                        messages, or using any data mining, robots, or similar data gathering and extraction tools.</span></p>
                    <p><span>11. Delete the copyright or other proprietary rights notice from any Content.</span></p>
                    <p><span>12. Attempt to impersonate another user or person or use the username of another user.</span></p>
                    <p><span>13. Upload or transmit (or attempt to upload or to transmit) any material that acts
                        as a passive or active information collection or transmission mechanism, including without
                        limitation, clear graphics interchange formats (“gifs”), 1×1 pixels, web bugs, cookies, or other
                        similar devices (sometimes referred to as “spyware” or “passive collection mechanisms” or “pcms”).</span></p>
                    <p><span>14. Interfere with, disrupt, or create an undue burden on the Site or the networks or services
                        connected to the Site.</span></p>
                    <p><span>15. Harass, annoy, intimidate, or threaten any of our employees or agents engaged in providing any
                        portion of the Site to you.</span></p>
                    <p><span>16. Attempt to bypass any measures of the Site designed to prevent or restrict access to the Site,
                        or any portion of the Site.</span></p>
                    <p><span>17. Copy or adapt the Site’s software, including but not limited to Flash, PHP, HTML,
                        JavaScript, or other code.</span></p>
                    <p><span>18. Except as permitted by applicable law, decipher, decompile, disassemble, or reverse engineer
                        any of the software comprising or in any way making up a part of the Site.</span></p>
                    <p><span>19. Except as may be the result of the standard search engine or Internet browser usage,
                        ...
                        using or launching any unauthorized script or other software.</span></p>
                    <p><span>20. Use a buying agent or purchasing agent to make purchases on the Site.</span></p>
                    <p><span>21. Make any unauthorized use of the Site, including collecting usernames and/or
                        email addresses of users by electronic or other means for the purpose of sending unsolicited
                        email, or creating user accounts by automated means or under false pretences.</span></p>
                    <p><span>22. Use the Site as part of any effort to compete with us or otherwise use the Site
                        and/or the Content for any revenue-generating endeavour or commercial enterprise.</span></p>
                    <p><span>23. Use the Site to advertise or offer to sell goods and services.</span></p>
                    <p><span>24. Sell or otherwise transfer your profile.</span></p>
                    <p className='single_gap'></p>
                    <p className='single_gap'></p>
                    <h3><p>USER-GENERATED CONTRIBUTIONS</p></h3>
                    <p className='single_gap'></p>
                    <p><span>The Site does not offer users to submit or post content. We may provide you with
                        the opportunity to create, submit, post, display, transmit, perform, publish, distribute,
                        or broadcast content and materials to us or on the Site, including but not limited to text,
                        writings, video, audio, photographs, graphics, comments, suggestions, or personal information
                        or other material (collectively, "Contributions"). Contributions may be viewable by other
                        users of the Site and through third-party websites. As such, any Contributions you transmit
                        may be treated in accordance with the Site Privacy Policy. When you create or make available
                        any Contributions, you thereby represent and warrant that:</span></p>
                    <p><span>1. The creation, distribution, transmission, public display, or performance,
                        ...
                        patent, trademark, trade secret, or moral rights of any third party.</span></p>
                    <p><span>2. You are the creator and owner of or have the necessary licenses, rights,
                    ...
                    <p><span>3. You have the written consent, release, and/or permission of each and every
                        ...
                        your Contributions in any manner contemplated by the Site and these Terms of Use.</span></p>
                    <p><span>4. Your Contributions are not false, inaccurate, or misleading.</span></p>
                    <p><span>5. Your Contributions are not unsolicited or unauthorized advertising, promotional
                        materials, pyramid schemes, chain letters, spam, mass mailings, or other forms of solicitation.</span></p>
                    <p><span>6. Your Contributions are not obscene, lewd, lascivious, filthy, violent, harassing, libellous,
                        slanderous, or otherwise objectionable (as determined by us).</span></p>
                    <p><span>7. Your Contributions do not ridicule, mock, disparage, intimidate, or abuse anyone.</span></p>
                    <p><span>8. Your Contributions are not used to harass or threaten (in the legal sense of those terms) any other
                        person and to promote violence against a specific person or class of people.</span></p>
                    ...
                    <p><span>11. Your Contributions do not violate any applicable law concerning child pornography,
                        or otherwise intended to protect the health or well-being of minors.</span></p>
                    <p><span>12. Your Contributions do not include any offensive comments that are connected to race,
                        national origin, gender, sexual preference, or physical handicap.</span></p>
                    <p><span>13. Your Contributions do not otherwise violate, or link to material that violates,
                        any provision of these Terms of Use, or any applicable law or regulation.</span></p>
                    <p><span>Any use of the Site in violation of the foregoing violates these Terms of Use and may result in, among
                        other things, termination or suspension of your rights to use the Site.</span></p>
                    <p className='single_gap'></p>
                    <p className='single_gap'></p>
                    <h3><span>CONTRIBUTION LICENSE</span></h3>
                    <p className='single_gap'></p>
                    <p><span>You and the Site agree that we may access, store, process, and use any information and
                        personal data that you provide following the terms of the Privacy Policy and your choices
                        (including settings).</span></p>
                    <p className='single_gap'></p>
                    <p><span>By submitting suggestions or other feedback regarding the Site, you agree that
                        we can use and share such feedback for any purpose without compensation to you.</span></p>
                    <p><span>We do not assert any ownership over your Contributions. You retain full ownership of all
                        ...
                        action against us regarding your Contributions.</span></p>
                    <p className='single_gap'></p>
                    <h3>MOBILE APPLICATION LICENSE</h3>
                    <p className='single_gap'></p>
                    <h4><span>Use License</span></h4>
                    <p className='single_gap'></p>
                    <p><span>If you access the Site via a mobile application, then we grant you a revocable,
                        ...
                        mobile application license contained in these Terms of Use. You shall not: (1)
                        ...
                        use of the application; (4) remove, alter, or obscure any proprietary notice (including any
                        notice of copyright or trademark) posted by us or the licensors of the application; (5) use
                        the application for any revenue generating endeavor, commercial enterprise, or other purpose
                        for which it is not designed or intended; (6) make the application available over a network
                        or other environment permitting access or use by multiple devices or users at the same time;
                        ...
                        queries to any website or to send any unsolicited commercial e-mail; or (9) use any proprietary information
                        or any of our interfaces or our other intellectual property in the design, development, manufacture, licensing,
                        or distribution of any applications, accessories, or devices for use with the application.</span></p>
                    <p className='single_gap'></p>
                    <h4><span>Apple and Android Devices</span></h4>
                    <p className='single_gap'></p>
                    <p><span>The following terms apply when you use a mobile application obtained from either the
                        ...
                        the application on a device that utilizes the Apple iOS or Android operating systems,
                        ...
                        may notify the applicable App Distributor, and the App Distributor, in accordance with its terms and policies,
                        ...
                        using the mobile application, e.g., if you have a VoIP application, then you must not be in violation
                        of their wireless data service agreement when using the mobile application; and (6) you acknowledge and
                        agree that the App Distributors are third-party beneficiaries of the terms and conditions in this mobile application
                        ...
                        license contained in these Terms of Use against you as a third-party beneficiary thereof.</span></p>
                    <p className='single_gap'></p>
                    <h4><span>SOCIAL MEDIA</span></h4>
                    <p className='single_gap'></p>
                    <p><span>As part of the functionality of the Site, you may link your account with online accounts
                        ...
                        fees or making us subject to any usage limitations imposed by the third-party service provider
                        of the Third-Party Account. By granting us access to any Third-Party Accounts, you understand
                        that (1) we may access, make available, and store (if applicable) any content that you have
                        provided to and stored in your Third-Party Account (the “Social Network Content”) so that
                        it is available on and through the Site via your account, including without limitation any
                        ...
                        post to your Third-Party Accounts may be available on and through your account on the Site.
                        ...
                        WITH SUCH THIRD-PARTY SERVICE PROVIDERS. We make no effort to review any Social Network Content
                        for any purpose, including but not limited to, for accuracy, legality, or non-infringement,
                        ...
                        list stored on your mobile device or tablet computer solely for purposes of identifying and
                        informing you of those contacts who have also registered to use the Site. You can deactivate
                        ...
                        to delete any information stored on our servers that was obtained through such Third-Party
                        Account, except the username and profile picture that become associated with your account.</span></p>
                    <p className='single_gap'></p>
                    <h4>SUBMISSIONS</h4>
                    <p className='single_gap'></p>
                    <p><span>You acknowledge and agree that any questions, comments, suggestions, ideas, feedback,
                        or other information regarding the Site ("Submissions") provided by you to us are non-confidential
                        ...
                        Submissions for any lawful purpose, commercial or otherwise, without acknowledgement or
                        compensation to you. You hereby waive all moral rights to any such Submissions, and you
                        hereby warrant that any such Submissions are original with you or that you have the right
                        to submit such Submissions. You agree there shall be no recourse against us for any alleged
                        or actual infringement or misappropriation of any proprietary right in your Submissions.</span></p>
                    <p className='single_gap'></p>
                    <h4>SITE MANAGEMENT</h4>
                    <p className='single_gap'></p>
                    <p><span>We reserve the right, but not the obligation, to: (1) monitor the Site for violations
                        of these Terms of Use; (2) take appropriate legal action against anyone who, in our sole
                        ...
                        Site in a manner designed to protect our rights and property and to facilitate the proper functioning
                        of the Site.</span></p>
                    <p className='single_gap'></p>
                    <p><span>PRIVACY POLICY</span></p>
                    <p><span>We care about data privacy and security. By using the Site, you agree to be bound by our
                        Privacy Policy posted on the Site, which is incorporated into these Terms of Use. Please be
                        advised the Site is hosted in__________. If you access the Site from any other region of the
                        world with laws or other requirements governing personal data collection, use, or disclosure
                        that differ from applicable laws in __________, then through your continued use of the Site,
                        you are transferring your data to __________, and you agree to have your data transferred to
                        and processed in __________.</span></p>
                    <p className='single_gap'></p>
                    <p className='single_gap'></p>
                    <h4><span>TERM AND TERMINATION</span></h4>
                    <p className='single_gap'></p>
                    <p><span>These Terms of Use shall remain in full force and effect while you use the Site.
                        ...
                        YOUR USE OR PARTICIPATION IN THE SITE OR DELETE YOUR ACCOUNT AND ANY CONTENT OR INFORMATION
                        THAT YOU POSTED AT ANY TIME, WITHOUT WARNING, IN OUR SOLE DISCRETION.</span></p>
                    <p className='single_gap'></p>
                    ...
                    <p className='single_gap'></p>
                    <p className='single_gap'></p>
                    <h4><span>MODIFICATIONS AND INTERRUPTIONS</span></h4>
                    <p className='single_gap'></p>
                    <p><span>We reserve the right to change, modify, or remove the contents of the Site at
                        any time or for any reason at our sole discretion without notice. However, we have no
                        ...
                        of the Site.</span></p>
                    <p className='single_gap'></p>
                    <p><span>We cannot guarantee the Site will be available at all times. We may experience
                        ...
                        or releases in connection therewith.</span></p>
                    <p className='single_gap'></p>
                    <p className='single_gap'></p>
                    <h4><span>GOVERNING LAW</span></h4>
                    <p className='single_gap'></p>
                    <p><span>These Terms of Use and your use of the Site are governed by and construed in
                    ...
                    <p><span>Any legal action of whatever nature brought by either you or us (collectively,
                        ...
                        state and federal courts located in Delaware, and the Parties hereby consent to and
                        waive all defences of lack of personal jurisdiction and forum non-conveniens with respect
                        to venue and jurisdiction in such state and federal courts. Application of the United
                        Nations Convention on Contracts for the International Sale of Goods and the Uniform
                        Computer Information Transaction Act (UCITA) are excluded from these Terms of Use.</span></p>
                    <p className='single_gap'></p>
                    <p className='single_gap'></p>
                    <h4><span>CORRECTIONS</span></h4>
                    <p className='single_gap'></p>
                    <p><span>There may be information on the Site that contains typographical errors, inaccuracies,
                        ...
                        the information on the Site at any time, without prior notice.</span></p>
                    <p className='single_gap'></p>
                    <p className='single_gap'></p>
                    <h4><span>DISCLAIMER</span></h4>
                    <p className='single_gap'></p>
                    <p><span>THE SITE IS PROVIDED ON AN AS-IS AND AS-AVAILABLE BASIS. YOU AGREE THAT YOUR USE
                        OF THE SITE AND OUR SERVICES WILL BE AT YOUR SOLE RISK. TO THE FULLEST EXTENT PERMITTED
                        BY LAW, WE DISCLAIM ALL WARRANTIES, EXPRESS OR IMPLIED, IN CONNECTION WITH THE SITE AND
                        ...
                        OF ANY WEBSITES LINKED TO THE SITE AND WE WILL ASSUME NO LIABILITY OR RESPONSIBILITY FOR
                        ...
                        ANY HYPERLINKED WEBSITE, OR ANY WEBSITE OR MOBILE APPLICATION FEATURED IN ANY BANNER
                    ...
                    <p className='single_gap'></p>
                    <p className='single_gap'></p>
                    <h4><span>LIMITATIONS OF LIABILITY</span></h4>
                    <p className='single_gap'></p>
                    <p><span>IN NO EVENT WILL WE OR OUR DIRECTORS, EMPLOYEES, OR AGENTS BE LIABLE TO YOU OR
                    ...
                    <p className='single_gap'></p>
                    <p className='single_gap'></p>
                    <h4><span>INDEMNIFICATION</span></h4>
                    <p className='single_gap'></p>
                    <p><span>You agree to defend, indemnify, and hold us harmless, including our
                        ...
                        including reasonable attorneys’ fees and expenses, made by any third party due to
                        or arising out of: (1) use of the Site; (2) breach of these Terms of Use; (3) any
                        breach of your representations and warranties set forth in these Terms of Use; (4)
                        your violation of the rights of a third party, including but not limited to
                        intellectual property rights; or (5) any overt harmful act toward any other user of
                        ...
                        at your expense, with our defence of such claims. We will use reasonable efforts
                        to notify you of any such claim, action, or
                        a proceeding which is subject to this indemnification upon becoming aware of it.</span></p>
                    <p className='single_gap'></p>
                    <p className='single_gap'></p>
                    <h4><span>USER DATA</span></h4>
                    <p className='single_gap'></p>
                    <p><span>We will maintain certain data that you transmit to the Site for the purpose of
                        ...
                        data that you transmit or that relates to any activity you have undertaken using the Site.
                    ...
                    <p><span>Visiting the Site, sending us emails, and completing online forms constitute
                        ...
                        any rights or requirements under any statutes, regulations, rules, ordinances, or other laws
                    ...
                    <p className='single_gap'></p>
                    <h4><span>CALIFORNIA USERS AND RESIDENTS</span></h4>
                    <p className='single_gap'></p>
                    <p className='single_gap'></p>
                    ...
                    <p><span>These Terms of Use and any policies or operating rules posted by us on the Site
                        ...
                        the fullest extent permissible by law. We may assign any or all of our rights and obligations
